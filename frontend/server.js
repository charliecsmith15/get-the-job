...
app.use(async (req, res, next) => {
    ...
    try {
        ...
        const define = {
            ...
            'process.env.ALLOWED_EMAILS': JSON.stringify(process.env.ALLOWED_EMAILS || 'charlie@workbench-data.com,rankin@workbench-data.com,charlie@charliecsmith.com,ccsmith1534@gmail.com'),
