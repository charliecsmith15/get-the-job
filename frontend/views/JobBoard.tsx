...
import { Plus, MoreVertical, ExternalLink, Search, MapPin, Calendar } from 'lucide-react';
...
export const JobBoard: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col crm-enter">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex space-x-4">
                    <div className="relative">
                        <Search className="w-4 h-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-taupe" />
                        <input 
                            type="text" 
            ...
            {isAdding && (
                <Card className="mb-6 p-4 border-wood bg-cream">
                    <form onSubmit={handleAddJob} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select 
                                    className="w-full px-3 py-2 border border-sand rounded-lg bg-paper text-ink crm-focus sm:text-sm"
                                    value={newJob.status}
